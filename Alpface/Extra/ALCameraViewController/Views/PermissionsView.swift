...
internal class PermissionsView: UIView {
    ...
    func configureInView(_ view: UIView, title: String, description: String, completion: @escaping ButtonAction) {
        ...
        closeButton.setImage(UIImage(named: "retakeButton", in: CameraGlobals.shared.bundle, compatibleWith: nil), for: .normal)
    ...
    func commonInit() {
        ...
        settingsButton.setTitle(localizedString("permissions.settings"), for: .normal)
