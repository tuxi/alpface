...
- (void)viewDidLoad {
    ...
    [_lefthWXBtn setImage:[UIImage imageNamed:@"icon_weixin_pyq_selected"] forState:UIControlStateSelected];
    [_lefthWXBtn setImage:[UIImage imageNamed:@"icon_weixin_pyq"] forState:UIControlStateNormal];
    ...
    [_rightWXBtn setImage:[UIImage imageNamed:@"icon_weixin_selected"] forState:UIControlStateSelected];
    [_rightWXBtn setImage:[UIImage imageNamed:@"icon_weixin"] forState:UIControlStateNormal];
