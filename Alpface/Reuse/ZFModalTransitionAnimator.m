...
- (void)animateTransition:(id<UIViewControllerContextTransitioning>)transitionContext
{
    ...
    if (!self.isDismiss) {
        ...
        toViewController.view.frame = CGRectMake(transformedPoint.x, toViewControllerDismissY, startRect.size.width, toViewControllerHeight);
         ...
         usingSpringWithDamping:0.8
          initialSpringVelocity:0.1
                     ...
                     animations:^{
                         ...
                         toViewController.view.alpha = self.behindViewAlpha;
                         CGFloat top = self.transitionContext.containerView.frame.size.height * (1.0 - self.topViewScale.heightScale);
                         fromViewController.view.frame = CGRectMake(0,top,
                                                                    CGRectGetWidth(fromViewController.view.frame),
                                                                    CGRectGetHeight(fromViewController.view.frame));
                     } completion:^(BOOL finished) {
